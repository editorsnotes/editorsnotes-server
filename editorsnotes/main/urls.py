...
list_patterns = patterns('editorsnotes.main.views',
...
project_list_patterns = patterns('editorsnotes.main.views',
...
project_item_patterns = patterns('editorsnotes.main.views',
