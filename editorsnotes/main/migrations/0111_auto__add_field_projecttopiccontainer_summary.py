...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectTopicContainer.summary'
        db.add_column(u'main_projecttopiccontainer', 'summary',
                      self.gf('editorsnotes.main.fields.XHTMLField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectTopicContainer.summary'
        db.delete_column(u'main_projecttopiccontainer', 'summary')
