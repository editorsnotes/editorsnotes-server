...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.description_digest'
        db.add_column(u'main_document', 'description_digest',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.description_digest'
        db.delete_column(u'main_document', 'description_digest')
    ...
    models = {
        ...
        'main.document': {
            ...
            'description_digest': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'}),
