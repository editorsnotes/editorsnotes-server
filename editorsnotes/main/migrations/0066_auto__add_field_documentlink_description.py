...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DocumentLink.description'
        db.add_column('main_documentlink', 'description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DocumentLink.description'
        db.delete_column('main_documentlink', 'description')
