...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Note.project'
        db.alter_column(u'main_note', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['main.Project']))

    def backwards(self, orm):
        # Adding M2M table for field affiliated_projects on 'Note'
        db.create_table(u'main_note_affiliated_projects', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('note', models.ForeignKey(orm['main.note'], null=False)),
            ('project', models.ForeignKey(orm['main.project'], null=False))
        ))
        db.create_unique(u'main_note_affiliated_projects', ['note_id', 'project_id'])


        # Changing field 'Note.project'
        db.alter_column(u'main_note', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['main.Project']))
