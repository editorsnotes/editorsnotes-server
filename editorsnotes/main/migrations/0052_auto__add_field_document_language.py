...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_document', 'language', self.gf('django.db.models.fields.CharField')(default='English', max_length=32), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Document.language'
        db.delete_column('main_document', 'language')
