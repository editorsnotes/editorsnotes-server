...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Document.bibtex'
        db.add_column('main_document', 'bibtex', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Document.bibtex'
        db.delete_column('main_document', 'bibtex')
