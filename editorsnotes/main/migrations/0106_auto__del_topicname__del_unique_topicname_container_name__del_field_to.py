...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'TopicName', fields ['container', 'name']
        db.delete_unique(u'main_topicname', ['container_id', 'name'])

        # Deleting model 'TopicName'
        db.delete_table(u'main_topicname')

        # Deleting field 'TopicNodeAssignment.topic_name'
        db.delete_column(u'main_topicnodeassignment', 'topic_name_id')

        # Disallow null value for ProjectTopicContainer.preferred_name
        db.alter_column(u'main_projecttopiccontainer', 'preferred_name',
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'main_topicname', (
            ('container', self.gf('django.db.models.fields.related.ForeignKey')(related_name='names', null=True, to=orm['main.ProjectTopicContainer'], blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length='200')),
            ('is_preferred', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='created_topicname_set', to=orm['main.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('main', ['TopicName'])

        # Adding unique constraint on 'TopicName', fields ['container', 'name']
        db.create_unique(u'main_topicname', ['container_id', 'name'])

        # Adding field 'TopicNodeAssignment.topic_name'
        db.add_column(u'main_topicnodeassignment', 'topic_name',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.TopicName'], null=True, blank=True),
                      keep_default=False)
