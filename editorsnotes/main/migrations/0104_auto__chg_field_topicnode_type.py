...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TopicNode.type'
        db.alter_column(u'main_topicnode', 'type', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

    def backwards(self, orm):

        # Changing field 'TopicNode.type'
        db.alter_column(u'main_topicnode', 'type', self.gf('django.db.models.fields.CharField')(default='', max_length=3))
