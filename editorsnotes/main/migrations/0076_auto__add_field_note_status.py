...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Note.status'
        db.add_column('main_note', 'status',
                      self.gf('django.db.models.fields.CharField')(default='0', max_length=1),
                      keep_default=False)

        # Adding M2M table for field assigned_users on 'Note'
        db.create_table('main_note_assigned_users', (
        ...
        db.create_unique('main_note_assigned_users', ['note_id', 'userprofile_id'])


    def backwards(self, orm):
        # Deleting field 'Note.status'
        db.delete_column('main_note', 'status')

        # Removing M2M table for field assigned_users on 'Note'
        db.delete_table('main_note_assigned_users')
