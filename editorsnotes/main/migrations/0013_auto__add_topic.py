...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Topic'
        db.create_table('main_topic', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='created_topic_set', to=orm['auth.User'])),
        ...
        db.send_create_signal('main', ['Topic'])


    def backwards(self, orm):
        
        # Deleting model 'Topic'
        db.delete_table('main_topic')
