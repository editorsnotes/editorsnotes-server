...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column('main_alias', 'topic_id', self.gf('django.db.models.fields.related.ForeignKey')(null=False, to=orm['main.Topic']))

    def backwards(self, orm):
        db.alter_column('main_alias', 'topic_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['main.Topic']))
