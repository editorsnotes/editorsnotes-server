...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.project'
        db.add_column(u'main_document', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='documents', null=True, to=orm['main.Project']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.project'
        db.delete_column(u'main_document', 'project_id')
