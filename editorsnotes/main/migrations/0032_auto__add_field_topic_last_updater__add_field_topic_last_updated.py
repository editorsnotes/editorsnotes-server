...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Topic.last_updater'
        db.add_column('main_topic', 'last_updater', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='last_to_update_topic_set', to=orm['auth.User']), keep_default=False)

        # Adding field 'Topic.last_updated'
        db.add_column('main_topic', 'last_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2010, 8, 31, 11, 40, 12, 962676), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Topic.last_updater'
        db.delete_column('main_topic', 'last_updater_id')

        # Deleting field 'Topic.last_updated'
        db.delete_column('main_topic', 'last_updated')
