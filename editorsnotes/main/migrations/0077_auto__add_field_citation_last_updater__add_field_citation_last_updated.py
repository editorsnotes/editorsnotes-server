...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Citation.last_updater'
        db.add_column('main_citation', 'last_updater',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='last_to_update_citation_set', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Citation.last_updated'
        db.add_column('main_citation', 'last_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 11, 7, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Citation.last_updater'
        db.delete_column('main_citation', 'last_updater_id')

        # Deleting field 'Citation.last_updated'
        db.delete_column('main_citation', 'last_updated')
