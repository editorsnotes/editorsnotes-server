...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TermAssignment.main'
        db.delete_column('main_termassignment', 'main')


    def backwards(self, orm):
        
        # Adding field 'TermAssignment.main'
        db.add_column('main_termassignment', 'main', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
