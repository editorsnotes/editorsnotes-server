...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Document.zotero_data'
        db.alter_column(u'main_document', 'zotero_data', self.gf('editorsnotes.djotero.fields.ZoteroField')(null=True))

    def backwards(self, orm):

        # Changing field 'Document.zotero_data'
        db.alter_column(u'main_document', 'zotero_data', self.gf('django.db.models.fields.TextField')(null=True))
