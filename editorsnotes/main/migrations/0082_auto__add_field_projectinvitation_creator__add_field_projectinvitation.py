...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectInvitation.creator'
        db.add_column('main_projectinvitation', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='created_projectinvitation_set', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'ProjectInvitation.created'
        db.add_column('main_projectinvitation', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 2, 7, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectInvitation.creator'
        db.delete_column('main_projectinvitation', 'creator_id')

        # Deleting field 'ProjectInvitation.created'
        db.delete_column('main_projectinvitation', 'created')
    ...
    models = {
        ...
        'main.projectinvitation': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'created_projectinvitation_set'", 'to': "orm['auth.User']"}),
