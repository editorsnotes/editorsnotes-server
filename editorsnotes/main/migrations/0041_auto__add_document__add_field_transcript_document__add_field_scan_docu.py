...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_document', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='created_document_set', to=orm['auth.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('last_updater', self.gf('django.db.models.fields.related.ForeignKey')(related_name='last_to_update_document_set', to=orm['auth.User'])),
        ...
        # Adding field 'Transcript.document'
        db.add_column('main_transcript', 'document', self.gf('django.db.models.fields.related.OneToOneField')(related_name='_transcript', unique=True, null=True, to=orm['main.Document']), keep_default=False)

        # Adding field 'Scan.document'
        db.add_column('main_scan', 'document', self.gf('django.db.models.fields.related.ForeignKey')(related_name='scans', null=True, to=orm['main.Document']), keep_default=False)

        # Adding field 'Citation.document'
        db.add_column('main_citation', 'document', self.gf('django.db.models.fields.related.ForeignKey')(related_name='citations', null=True, to=orm['main.Document']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Document'
        db.delete_table('main_document')

        # Deleting field 'Transcript.document'
        db.delete_column('main_transcript', 'document_id')

        # Deleting field 'Scan.document'
        db.delete_column('main_scan', 'document_id')

        # Deleting field 'Citation.document'
        db.delete_column('main_citation', 'document_id')
