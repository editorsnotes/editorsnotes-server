...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'NoteSection', fields ['note', 'note_section_id']
        db.create_unique(u'main_notesection', ['note_id', 'note_section_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'NoteSection', fields ['note', 'note_section_id']
        db.delete_unique(u'main_notesection', ['note_id', 'note_section_id'])
