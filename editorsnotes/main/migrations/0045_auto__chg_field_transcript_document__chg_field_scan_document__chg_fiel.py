...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Transcript.document'
        db.alter_column('main_transcript', 'document_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['main.Document']))

        # Changing field 'Scan.document'
        db.alter_column('main_scan', 'document_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Document']))

        # Changing field 'Citation.document'
        db.alter_column('main_citation', 'document_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Document']))


    def backwards(self, orm):
        
        # Changing field 'Transcript.document'
        db.alter_column('main_transcript', 'document_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['main.Document']))

        # Changing field 'Scan.document'
        db.alter_column('main_scan', 'document_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['main.Document']))

        # Changing field 'Citation.document'
        db.alter_column('main_citation', 'document_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['main.Document']))
