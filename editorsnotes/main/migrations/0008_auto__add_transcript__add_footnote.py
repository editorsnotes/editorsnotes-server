...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_transcript', (
    ...
    def backwards(self, orm):
        ...
        db.delete_table('main_transcript')

        # Deleting model 'Footnote'
        db.delete_table('main_footnote')
    ...
    models = {
        ...
        'main.transcript': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'source': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['main.Source']", 'unique': 'True'})
        },
        'main.userprofile': {
