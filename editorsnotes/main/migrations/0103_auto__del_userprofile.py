...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'main_userprofile', (
            ('zotero_key', self.gf('django.db.models.fields.CharField')(max_length='24', null=True, blank=True)),
            ('zotero_uid', self.gf('django.db.models.fields.CharField')(max_length='6', null=True, blank=True)),
