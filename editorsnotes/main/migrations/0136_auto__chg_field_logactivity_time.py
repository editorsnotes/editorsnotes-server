...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LogActivity.time'
        db.alter_column(u'main_logactivity', 'time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'LogActivity.time'
        db.alter_column(u'main_logactivity', 'time', self.gf('django.db.models.fields.DateTimeField')())
