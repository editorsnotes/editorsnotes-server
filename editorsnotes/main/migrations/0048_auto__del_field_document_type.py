...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('main_document', 'type')


    def backwards(self, orm):
        
        # Adding field 'Document.type'
        db.add_column('main_document', 'type', self.gf('django.db.models.fields.CharField')(default='S', max_length=1), keep_default=False)
