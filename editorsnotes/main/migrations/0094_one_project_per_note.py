...
class Migration(DataMigration):
    def forwards(self, orm):
        ...
        for note in orm['main.note'].objects.all():
            note.project = project_by_uid(note.creator_id, orm)
            note.save()

            versions = orm['reversion.version'].objects.filter(
                content_type=note_ct, object_id=note.id)
