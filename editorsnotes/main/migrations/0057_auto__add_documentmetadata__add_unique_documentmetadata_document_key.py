...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_documentmetadata', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='created_documentmetadata_set', to=orm['auth.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('document', self.gf('django.db.models.fields.related.ForeignKey')(related_name='metadata', to=orm['main.Document'])),
            ('key', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('value', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('main', ['DocumentMetadata'])

        # Adding unique constraint on 'DocumentMetadata', fields ['document', 'key']
        db.create_unique('main_documentmetadata', ['document_id', 'key'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'DocumentMetadata', fields ['document', 'key']
        db.delete_unique('main_documentmetadata', ['document_id', 'key'])

        # Deleting model 'DocumentMetadata'
        db.delete_table('main_documentmetadata')
