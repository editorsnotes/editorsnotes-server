...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Topic.article'
        db.delete_column('main_topic', 'article_id')


    def backwards(self, orm):
        
        # Adding field 'Topic.article'
        db.add_column('main_topic', 'article', self.gf('django.db.models.fields.related.OneToOneField')(related_name='main_topic', unique=True, null=True, to=orm['main.Note'], blank=True), keep_default=False)
