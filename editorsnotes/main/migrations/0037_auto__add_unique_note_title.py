...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Note', fields ['title']
        db.create_unique('main_note', ['title'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Note', fields ['title']
        db.delete_unique('main_note', ['title'])
