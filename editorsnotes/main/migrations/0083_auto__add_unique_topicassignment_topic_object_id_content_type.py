...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Delete any non-unique TopicAssignment objects
        duplicates = orm['main.topicassignment'].objects.raw(
            'SELECT * FROM main_topicassignment WHERE id NOT IN ' +
            '(SELECT DISTINCT ON (topic_id, content_type_id, object_id) id FROM main_topicassignment);')
        for duplicate in duplicates:
            duplicate_qs = orm['main.topicassignment'].objects.filter(
                topic=duplicate.topic,
                content_type=duplicate.content_type,
                object_id=duplicate.object_id
            ).order_by('-created')
            for to_delete in duplicate_qs[1:]:
                to_delete.delete()

        # Adding unique constraint on 'TopicAssignment', fields ['topic', 'object_id', 'content_type']
        db.create_unique(u'main_topicassignment', ['topic_id', 'object_id', 'content_type_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'TopicAssignment', fields ['topic', 'object_id', 'content_type']
        db.delete_unique(u'main_topicassignment', ['topic_id', 'object_id', 'content_type_id'])
    ...
    models = {
        ...
        u'main.alias': {
            ...
            'topic': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'aliases'", 'to': u"orm['main.Topic']"})
        },
        u'main.citation': {
            ...
            'document': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'citations'", 'to': u"orm['main.Document']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'main.document': {
            ...
            'affiliated_projects': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['main.Project']", 'null': 'True', 'blank': 'True'}),
            'collection': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'parts'", 'null': 'True', 'to': u"orm['main.Document']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'main.documentlink': {
            ...
            'document': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'links'", 'to': u"orm['main.Document']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'url': ('django.db.models.fields.URLField', [], {'max_length': '200'})
        },
        u'main.documentmetadata': {
            ...
            'document': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'metadata'", 'to': u"orm['main.Document']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'main.footnote': {
            ...
            'transcript': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'footnotes'", 'to': u"orm['main.Transcript']"})
        },
        u'main.note': {
            'Meta': {'ordering': "['-last_updated']", 'object_name': 'Note'},
            'affiliated_projects': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['main.Project']", 'null': 'True', 'blank': 'True'}),
            'assigned_users': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['main.UserProfile']", 'null': 'True', 'blank': 'True'}),
            'content': ('editorsnotes.main.fields.XHTMLField', [], {}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'main.notesection': {
            ...
            'document': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Document']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'last_updater': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'last_to_update_notesection_set'", 'to': u"orm['auth.User']"}),
            'note': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sections'", 'to': u"orm['main.Note']"})
        },
        u'main.project': {
        ...
        u'main.scan': {
            ...
            'document': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'scans'", 'to': u"orm['main.Document']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'main.topic': {
            ...
            'related_topics': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'related_topics_rel_+'", 'blank': 'True', 'to': u"orm['main.Topic']"}),
        ...
        u'main.topicassignment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'topic': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'assignments'", 'to': u"orm['main.Topic']"})
        },
        u'main.transcript': {
            ...
            'document': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'_transcript'", 'unique': 'True', 'to': u"orm['main.Document']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
        ...
        u'main.userprofile': {
            ...
            'affiliation': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'members'", 'null': 'True', 'to': u"orm['main.Project']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
