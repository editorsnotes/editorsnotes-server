...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Topic => LegacyTopic
        db.rename_table(u'main_topic', u'main_legacytopic')

        # ProjectTopicContainer => Topic
        #   - column topic => topic_node
        db.rename_table(u'main_projecttopiccontainer', u'main_topic')
        db.rename_column(u'main_topic', 'topic_id', 'topic_node_id')

        # AlternateName
        #   - column container => topic
        db.delete_unique(u'main_alternatename', ['container_id', 'name'])
        db.rename_column(u'main_alternatename', 'container_id', 'topic_id')
        db.create_unique(u'main_alternatename', ['topic_id', 'name'])


        # TopicNodeAssignment => TopicAssignment
        #   - column container => topic
        db.rename_table(u'main_topicnodeassignment', u'main_topicassignment')
        db.delete_unique(u'main_topicassignment', ['content_type_id', 'object_id', 'container_id'])
        db.rename_column(u'main_topicassignment', 'container_id', 'topic_id')
    ...
    models = {
        ...
        'main.project': {
            ...
            'default_license': ('django.db.models.fields.related.ForeignKey', [], {'default': '6', 'to': u"orm['licensing.License']"}),
