...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Transcript.last_updated'
        db.alter_column('main_transcript', 'last_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Transcript.last_updater'
        db.alter_column('main_transcript', 'last_updater_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Footnote.last_updated'
        db.alter_column('main_footnote', 'last_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Footnote.last_updater'
        db.alter_column('main_footnote', 'last_updater_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Source.last_updated'
        db.alter_column('main_source', 'last_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Source.last_updater'
        db.alter_column('main_source', 'last_updater_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Transcript.last_updated'
        db.alter_column('main_transcript', 'last_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))

        # Changing field 'Transcript.last_updater'
        db.alter_column('main_transcript', 'last_updater_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Footnote.last_updated'
        db.alter_column('main_footnote', 'last_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))

        # Changing field 'Footnote.last_updater'
        db.alter_column('main_footnote', 'last_updater_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Source.last_updated'
        db.alter_column('main_source', 'last_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))

        # Changing field 'Source.last_updater'
        db.alter_column('main_source', 'last_updater_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
