...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'main_note', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='proj', null=True, to=orm['main.Project']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Note.project'
        db.delete_column(u'main_note', 'project_id')
    ...
    models = {
        ...
        'main.note': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'proj'", 'null': 'True', 'to': "orm['main.Project']"}),
