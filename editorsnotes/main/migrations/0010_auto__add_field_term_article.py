...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Term.article'
        db.add_column('main_term', 'article', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['main.Note'], unique=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Term.article'
        db.delete_column('main_term', 'article_id')
