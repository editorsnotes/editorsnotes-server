...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field affiliated_projects on 'Transcript'
        db.delete_table('main_transcript_affiliated_projects')

        # Removing M2M table for field affiliated_projects on 'Document'
        db.delete_table('main_document_affiliated_projects')


        # Changing field 'Document.project'
        db.alter_column(u'main_document', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['main.Project']))

    def backwards(self, orm):
        # Adding M2M table for field affiliated_projects on 'Transcript'
        db.create_table(u'main_transcript_affiliated_projects', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('transcript', models.ForeignKey(orm['main.transcript'], null=False)),
            ('project', models.ForeignKey(orm['main.project'], null=False))
        ))
        db.create_unique(u'main_transcript_affiliated_projects', ['transcript_id', 'project_id'])

        # Adding M2M table for field affiliated_projects on 'Document'
        db.create_table(u'main_document_affiliated_projects', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('document', models.ForeignKey(orm['main.document'], null=False)),
            ('project', models.ForeignKey(orm['main.project'], null=False))
        ))
        db.create_unique(u'main_document_affiliated_projects', ['document_id', 'project_id'])


        # Changing field 'Document.project'
        db.alter_column(u'main_document', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['main.Project']))
