...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Topic', fields ['project', 'topic_node']
        db.create_unique(u'main_topic', ['project_id', 'topic_node_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Topic', fields ['project', 'topic_node']
        db.delete_unique(u'main_topic', ['project_id', 'topic_node_id'])
