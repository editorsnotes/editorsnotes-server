...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_featureditem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='created_featureditem_set', to=orm['auth.User'])),
        ...
        db.send_create_signal('main', ['FeaturedItem'])


    def backwards(self, orm):
        # Deleting model 'FeaturedItem'
        db.delete_table('main_featureditem')
