...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TopicAssignment.content_type'
        db.add_column('main_topicassignment', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['contenttypes.ContentType']), keep_default=False)

        # Adding field 'TopicAssignment.object_id'
        db.add_column('main_topicassignment', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TopicAssignment.content_type'
        db.delete_column('main_topicassignment', 'content_type_id')

        # Deleting field 'TopicAssignment.object_id'
        db.delete_column('main_topicassignment', 'object_id')
