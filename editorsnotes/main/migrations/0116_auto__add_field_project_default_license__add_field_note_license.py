...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.default_license'
        db.add_column(u'main_project', 'default_license',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=6, to=orm['licensing.License']),
                      keep_default=False)

        # Adding field 'Note.license'
        db.add_column(u'main_note', 'license',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['licensing.License'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.default_license'
        db.delete_column(u'main_project', 'default_license_id')

        # Deleting field 'Note.license'
        db.delete_column(u'main_note', 'license_id')
