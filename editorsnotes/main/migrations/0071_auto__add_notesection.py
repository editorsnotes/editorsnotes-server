...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NoteSection'
        db.create_table('main_notesection', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='created_notesection_set', to=orm['auth.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('last_updater', self.gf('django.db.models.fields.related.ForeignKey')(related_name='last_to_update_notesection_set', to=orm['auth.User'])),
            ('last_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('note', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Note'])),
            ('document', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Document'], null=True, blank=True)),
            ('content', self.gf('editorsnotes.main.fields.XHTMLField')()),
        ))
        db.send_create_signal('main', ['NoteSection'])


    def backwards(self, orm):
        
        # Deleting model 'NoteSection'
        db.delete_table('main_notesection')
