...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_note', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length='80', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Note.title'
        db.delete_column('main_note', 'title')
