...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LogActivity'
        db.create_table(u'main_logactivity', (
        ...
        db.send_create_signal('main', ['LogActivity'])


    def backwards(self, orm):
        # Deleting model 'LogActivity'
        db.delete_table(u'main_logactivity')
