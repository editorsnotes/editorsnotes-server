...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Citation.content_type'
        db.add_column('main_citation', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['contenttypes.ContentType']), keep_default=False)

        # Adding field 'Citation.object_id'
        db.add_column('main_citation', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Citation.content_type'
        db.delete_column('main_citation', 'content_type_id')

        # Deleting field 'Citation.object_id'
        db.delete_column('main_citation', 'object_id')
