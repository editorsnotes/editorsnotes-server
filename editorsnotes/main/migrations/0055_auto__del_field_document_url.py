...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('main_document', 'url')


    def backwards(self, orm):
        
        # We cannot add back in field 'Document.url'
        raise RuntimeError(
            "Cannot reverse this migration. 'Document.url' and its values cannot be restored.")
