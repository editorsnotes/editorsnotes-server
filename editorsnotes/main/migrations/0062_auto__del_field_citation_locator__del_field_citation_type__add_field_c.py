...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Citation.locator'
        db.delete_column('main_citation', 'locator')

        # Deleting field 'Citation.type'
        db.delete_column('main_citation', 'type')

        # Adding field 'Citation.ordering'
        db.add_column('main_citation', 'ordering', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Citation.locator'
        db.add_column('main_citation', 'locator', self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True), keep_default=False)

        # Adding field 'Citation.type'
        db.add_column('main_citation', 'type', self.gf('django.db.models.fields.CharField')(default='S', max_length=1), keep_default=False)

        # Deleting field 'Citation.ordering'
        db.delete_column('main_citation', 'ordering')
    ...
    models = {
        ...
        'main.document': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'import_id': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '32', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
