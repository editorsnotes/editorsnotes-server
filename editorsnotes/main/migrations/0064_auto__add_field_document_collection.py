...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_document', 'collection', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Document'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Document.collection'
        db.delete_column('main_document', 'collection_id')
    ...
    models = {
        ...
        'main.document': {
            ...
            'collection': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Document']", 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
