...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_document_affiliated_projects', (
        ...
        db.create_unique('main_document_affiliated_projects', ['document_id', 'project_id'])

        # Adding M2M table for field affiliated_projects on 'Note'
        db.create_table('main_note_affiliated_projects', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('note', models.ForeignKey(orm['main.note'], null=False)),
            ('project', models.ForeignKey(orm['main.project'], null=False))
        ))
        db.create_unique('main_note_affiliated_projects', ['note_id', 'project_id'])

        # Adding M2M table for field affiliated_projects on 'Topic'
        db.create_table('main_topic_affiliated_projects', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('topic', models.ForeignKey(orm['main.topic'], null=False)),
            ('project', models.ForeignKey(orm['main.project'], null=False))
        ))
        db.create_unique('main_topic_affiliated_projects', ['topic_id', 'project_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field affiliated_projects on 'Note'
        db.delete_table('main_note_affiliated_projects')
    ...
    models = {
        ...
        'main.document': {
            ...
            'affiliated_projects': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['main.Project']", 'symmetrical': 'False'}),
