...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_project', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Project.description'
        db.add_column('main_project', 'description', self.gf('editorsnotes.main.fields.XHTMLField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.image'
        db.delete_column('main_project', 'image')

        # Deleting field 'Project.description'
        db.delete_column('main_project', 'description')
