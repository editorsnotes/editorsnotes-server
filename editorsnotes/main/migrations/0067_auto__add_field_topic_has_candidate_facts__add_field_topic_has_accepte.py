...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_topic', 'has_candidate_facts', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Topic.has_accepted_facts'
        db.add_column('main_topic', 'has_accepted_facts', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Topic.has_candidate_facts'
        db.delete_column('main_topic', 'has_candidate_facts')

        # Deleting field 'Topic.has_accepted_facts'
        db.delete_column('main_topic', 'has_accepted_facts')
