...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Scan.image_thumbnail'
        db.add_column(u'main_scan', 'image_thumbnail',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Scan.image_thumbnail'
        db.delete_column(u'main_scan', 'image_thumbnail')
