...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Document.edtf_date'
        db.add_column('main_document', 'edtf_date', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Document.edtf_date'
        db.delete_column('main_document', 'edtf_date')
