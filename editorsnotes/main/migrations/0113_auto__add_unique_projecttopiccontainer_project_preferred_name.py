...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ProjectTopicContainer', fields ['project', 'preferred_name']
        db.create_unique(u'main_projecttopiccontainer', ['project_id', 'preferred_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProjectTopicContainer', fields ['project', 'preferred_name']
        db.delete_unique(u'main_projecttopiccontainer', ['project_id', 'preferred_name'])
