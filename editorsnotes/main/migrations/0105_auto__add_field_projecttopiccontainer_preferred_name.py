...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectTopicContainer.preferred_name'
        db.add_column(u'main_projecttopiccontainer', 'preferred_name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        qs = orm['main.projecttopiccontainer'].objects.select_related('topicname')
        for container in qs:
            name = container.names.get(is_preferred=True)
            container.preferred_name = name.name
            container.save()

    def backwards(self, orm):
        # Deleting field 'ProjectTopicContainer.preferred_name'
        db.delete_column(u'main_projecttopiccontainer', 'preferred_name')
    ...
    models = {
        ...
        'main.projecttopiccontainer': {
            ...
            'preferred_name': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
        ...
        'main.topicname': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'created_topicname_set'", 'to': "orm['main.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
