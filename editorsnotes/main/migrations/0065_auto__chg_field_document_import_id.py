...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Document.import_id'
        db.alter_column('main_document', 'import_id', self.gf('django.db.models.fields.CharField')(max_length=64, unique=True, null=True))


    def backwards(self, orm):
        
        # Changing field 'Document.import_id'
        db.alter_column('main_document', 'import_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32, null=True))
