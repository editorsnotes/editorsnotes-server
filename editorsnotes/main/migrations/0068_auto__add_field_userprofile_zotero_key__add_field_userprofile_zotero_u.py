...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.zotero_key'
        db.add_column('main_userprofile', 'zotero_key', self.gf('django.db.models.fields.CharField')(max_length='24', null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.zotero_uid'
        db.add_column('main_userprofile', 'zotero_uid', self.gf('django.db.models.fields.CharField')(max_length='6', null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.zotero_key'
        db.delete_column('main_userprofile', 'zotero_key')

        # Deleting field 'UserProfile.zotero_uid'
        db.delete_column('main_userprofile', 'zotero_uid')
