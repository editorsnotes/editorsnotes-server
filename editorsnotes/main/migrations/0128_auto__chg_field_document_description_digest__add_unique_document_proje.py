...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Document.description_digest'
        db.alter_column(u'main_document', 'description_digest', self.gf('django.db.models.fields.CharField')(default=1, max_length=32))
        # Adding unique constraint on 'Document', fields ['project', 'description_digest']
        db.create_unique(u'main_document', ['project_id', 'description_digest'])


    def backwards(self, orm):
        # Removing unique constraint on 'Document', fields ['project', 'description_digest']
        db.delete_unique(u'main_document', ['project_id', 'description_digest'])


        # Changing field 'Document.description_digest'
        db.alter_column(u'main_document', 'description_digest', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
