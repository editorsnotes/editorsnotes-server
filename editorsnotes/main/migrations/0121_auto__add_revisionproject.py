...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RevisionProject'
        db.create_table(u'main_revisionproject', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('revision', self.gf('django.db.models.fields.related.OneToOneField')(related_name='project', unique=True, to=orm['reversion.Revision'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Project'])),
        ))
        db.send_create_signal('main', ['RevisionProject'])


    def backwards(self, orm):
        # Deleting model 'RevisionProject'
        db.delete_table(u'main_revisionproject')
    ...
    models = {
        ...
        'main.revisionproject': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Project']"}),
            'revision': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'project'", 'unique': 'True', 'to': u"orm['reversion.Revision']"})
        },
        'main.scan': {
