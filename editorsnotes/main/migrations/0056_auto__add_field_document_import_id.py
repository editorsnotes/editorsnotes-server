...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Document.import_id'
        db.add_column('main_document', 'import_id', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=32, unique=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Document.import_id'
        db.delete_column('main_document', 'import_id')
