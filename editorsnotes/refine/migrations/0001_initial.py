...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('refine_topiccluster', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('refine', ['TopicCluster'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('refine_topiccluster')
    ...
    models = {
        ...
        'refine.topiccluster': {
            ...
            'clustered_topics': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['main.Topic']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        }
    }
