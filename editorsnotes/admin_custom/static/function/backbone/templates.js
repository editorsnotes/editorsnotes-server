...
EditorsNotes.Templates['wysihtml5_toolbar'] = _.template(''
  ...
  + '<% if (!type === "minimal" ) { %>'
      + ''
      + '<a class="btn" data-wysihtml5-command="formatBlock" wysihtml5-command-value="p">'
        + '<strong>P</strong>'
      + '</a>'
      + ''
      + '<a class="btn" data-wysihtml5-command="formatBlock" wysihtml5-command-value="h1">'
        + '<strong>H1</strong>'
      + '</a>'
      + ''
      + '<a class="btn" data-wysihtml5-command="formatBlock" wysihtml5-command-value="h2">'
        + '<strong>H2</strong>'
      + '</a>'
      + ''
      + '<a class="btn" data-wysihtml5-command="formatBlock" wysihtml5-command-value="h3">'
        + '<strong>H3</strong>'
      + '</a>'
      + ''
