...
urlpatterns = patterns('',
    ...
    url(r'^topics/(?P<topic_node_id>\d+)/edit/$', views.topics.TopicAdminView.as_view(), name='change_topic_view'),
    url(r'^documents/add/$', views.documents.DocumentAdminView.as_view(), name='add_document_view'),
    url(r'^documents/(?P<document_id>\d+)/edit/$', views.documents.DocumentAdminView.as_view(), name='change_document_view'),
    url(r'^documents/(?P<document_id>\d+)/transcript/edit/$', views.documents.TranscriptAdminView.as_view(), name='change_transcript_view'),
    url(r'^notes/add/$', views.notes.NoteAdminView.as_view(), name='add_note_view'),
    url(r'^notes/(?P<note_id>\d+)/edit/$', views.notes.NoteAdminView.as_view(), name='change_note_view'),
