...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ZoteroLink.doc'
        db.alter_column('djotero_zoterolink', 'doc_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['main.Document']))

        # Adding unique constraint on 'ZoteroLink', fields ['doc']
        db.create_unique('djotero_zoterolink', ['doc_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ZoteroLink', fields ['doc']
        db.delete_unique('djotero_zoterolink', ['doc_id'])

        # Changing field 'ZoteroLink.doc'
        db.alter_column('djotero_zoterolink', 'doc_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Document']))
    ...
    models = {
        ...
        'djotero.zoterolink': {
            ...
            'doc': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'zotero_link'", 'unique': 'True', 'to': "orm['main.Document']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'zotero_data': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'zotero_url': ('django.db.models.fields.URLField', [], {'max_length': '200'})
        },
        'main.citation': {
