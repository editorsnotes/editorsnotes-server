...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ZoteroLink.modified'
        db.add_column('djotero_zoterolink', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 1, 25, 14, 38, 21, 485663), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ZoteroLink.modified'
        db.delete_column('djotero_zoterolink', 'modified')
