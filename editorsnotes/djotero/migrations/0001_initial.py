...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ZoteroLink'
        db.create_table('djotero_zoterolink', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('doc', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Document'])),
            ('zotero_url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('zotero_data', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('djotero', ['ZoteroLink'])


    def backwards(self, orm):
        
        # Deleting model 'ZoteroLink'
        db.delete_table('djotero_zoterolink')
    ...
    models = {
        ...
        'djotero.zoterolink': {
            ...
            'doc': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Document']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
