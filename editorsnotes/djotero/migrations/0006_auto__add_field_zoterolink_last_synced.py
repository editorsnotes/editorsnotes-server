...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ZoteroLink.last_synced'
        db.add_column('djotero_zoterolink', 'last_synced', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ZoteroLink.last_synced'
        db.delete_column('djotero_zoterolink', 'last_synced')
