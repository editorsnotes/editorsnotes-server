...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ZoteroLink.date_information'
        db.add_column('djotero_zoterolink', 'date_information', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ZoteroLink.date_information'
        db.delete_column('djotero_zoterolink', 'date_information')
