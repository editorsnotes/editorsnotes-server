...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CachedCreator'
        db.create_table('djotero_cachedcreator', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('djotero', ['CachedCreator'])

        # Adding model 'CachedArchive'
        db.create_table('djotero_cachedarchive', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('djotero', ['CachedArchive'])

        # Adding field 'ZoteroLink.cached_archive'
        db.add_column('djotero_zoterolink', 'cached_archive', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djotero.CachedArchive'], null=True, blank=True), keep_default=False)

        # Adding M2M table for field cached_creator on 'ZoteroLink'
        db.create_table('djotero_zoterolink_cached_creator', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('zoterolink', models.ForeignKey(orm['djotero.zoterolink'], null=False)),
            ('cachedcreator', models.ForeignKey(orm['djotero.cachedcreator'], null=False))
        ))
        db.create_unique('djotero_zoterolink_cached_creator', ['zoterolink_id', 'cachedcreator_id'])


    def backwards(self, orm):
        
        # Deleting model 'CachedCreator'
        db.delete_table('djotero_cachedcreator')

        # Deleting model 'CachedArchive'
        db.delete_table('djotero_cachedarchive')

        # Deleting field 'ZoteroLink.cached_archive'
        db.delete_column('djotero_zoterolink', 'cached_archive_id')

        # Removing M2M table for field cached_creator on 'ZoteroLink'
        db.delete_table('djotero_zoterolink_cached_creator')
    ...
    models = {
        ...
        'djotero.cachedarchive': {
            'Meta': {'object_name': 'CachedArchive'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.TextField', [], {})
        },
        'djotero.cachedcreator': {
        ...
        'djotero.zoterolink': {
            ...
            'cached_archive': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['djotero.CachedArchive']", 'null': 'True', 'blank': 'True'}),
            'cached_creator': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['djotero.CachedCreator']", 'null': 'True', 'blank': 'True'}),
